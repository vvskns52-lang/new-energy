...
/* ==========================================
   ...
   ========================================== */
const MAP_MISSIONS = [
    { id: 'seohae', name: '서해안 (경기만 일대)', x: 130, y: 150, hint: '이곳 서해안은 밀물과 썰물의 수위 차(낙차)가 세계적으로 큽니다. 방조제를 쌓아 만들 수 있는 이 발전은?', correct: 'tidal_barrage' },
    { id: 'jeju', name: '제주도', x: 250, y: 470, hint: '제주도는 연중 바람이 매우 강하게 부는 지역입니다. 거대한 회전 날개를 세워 전기를 만드는 이 발전은?', correct: 'wind' },
    { id: 'donghae', name: '동해안·울릉도', x: 420, y: 100, hint: '울릉도와 동해안은 파도가 높게 치는 곳입니다. 파도의 상하 출렁임을 이용해 부표를 띄우는 이 발전은?', correct: 'wave' },
    { id: 'city', name: '수도권 대도시', x: 180, y: 110, hint: '이곳은 인구가 밀집된 대도시입니다. 아파트 베란다나 건물 옥상 유휴 공간에 쉽게 설치할 수 있는 발전은?', correct: 'solar' },
    { id: 'mountain', name: '태백산맥 산간 지역', x: 300, y: 110, hint: '이곳은 산세가 험하고 비가 많이 와 물을 가두기 좋습니다. 댐을 건설하여 물의 위치에너지를 이용하는 이 발전은?', correct: 'hydro' },
    { id: 'base', name: '남동 임해 산업 단지', x: 380, y: 350, hint: '이곳은 대규모 산업 단지가 있어 24시간 안정적인 기저 전력이 필요합니다. 우라늄을 원료로 하는 이 발전은?', correct: 'nuclear' }
];
